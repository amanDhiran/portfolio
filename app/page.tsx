    ...
    <div className="mt-6 flex flex-col gap-16">
      ...
      <section>
        ...
        <div className="mt-11 grid md:grid-cols-2 gap-10">
          {projectData.map((project) => <ProjectCard  name={project.name} thumbnail={project.href} techStack={project.techStack} key={project.name} live={project.live} code={project.code} description={project.description} />)}
        </div>
      </section>
    </div>
  );
